...
PlaceObj('ModItemBuildingTemplate', {
	...
	'display_name', T(999912333, --[[ModItemBuildingTemplate HydroPlant display_name]] "Hydroelectric Plant"),
	'display_name_pl', T(999912334, --[[ModItemBuildingTemplate HydroPlant display_name_pl]] "Hydroelectric Plants"),
	'description', T(999912335, --[[ModItemBuildingTemplate HydroPlant description]] "Produces electricity from water."),
...
PlaceObj('ModItemMissionLogoPreset', {
	SortKey = 100000,
	display_name = T(999912331, --[[ModItemMissionLogoPreset TurkeyDecal display_name]] "Turkey"),
	entity_name = "TurkeyDecal",
